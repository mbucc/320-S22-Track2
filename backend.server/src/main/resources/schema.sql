DROP TABLE IF EXISTS BUSINESS_PROCESS_T;
DROP TABLE IF EXISTS LOG_DETAILS_T;
DROP TABLE IF EXISTS LOG_APP_CONTEXT_T;
DROP TABLE IF EXISTS BUSINESS_PROCESS_LOG_T;
